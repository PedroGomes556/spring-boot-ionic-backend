...
import com.pedrogomes.cursmc.domain.enums.Perfil;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Categoria cat5 = new Categoria(null, "Jardinação");
		...
		Produto p8 = new Produto(null, "Rochadeira", 800.00);
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "pedrogomesps4xboxone@gmail.com", "363789112377", 
				TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838303"));
		
		Cliente cli2 = new Cliente(null, "Ana Martins", "pedro.gomes@dcx.ufpb.br", "76888351009", 
				TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("21212543", "989657421"));
		cli2.addPerfil(Perfil.ADMIM);
		
		
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Cento", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Cento", "38875445", cli2, c2);
