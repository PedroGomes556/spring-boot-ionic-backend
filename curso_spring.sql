...
--
-- Host: localhost
-- Tempo de geração: 25-Abr-2022 às 02:34
...
INSERT INTO `cliente` (`id`, `cpf_ou_cnpj`, `email`, `name`, `tipo`) VALUES
(1, '363789112377', 'maria@gmail.com', 'Maria Silva', 1);
...
INSERT INTO `endereco` (`id`, `bairro`, `complemento`, `cpf`, `logradouro`, `numero`, `cidade_id`, `cliente_id`) VALUES
(1, 'Jardim', 'Apto 303', '38220834', 'Rua Flores', '300', 1, 1),
(2, 'Cento', 'Sala 800', '38777012', 'Avenida Matos', '105', 2, 1);
...
INSERT INTO `item_pedido` (`desconto`, `preco`, `quantidade`, `pedido_id`, `prduto_id`) VALUES
(0, 2000, 1, 1, 1),
(0, 80, 2, 1, 3),
(100, 800, 1, 2, 2);
...
ALTER TABLE `item_pedido`
  ADD PRIMARY KEY (`pedido_id`,`prduto_id`),
  ADD KEY `FKsr7cp0iywhr8amwh3mkledigp` (`prduto_id`);
...
ALTER TABLE `item_pedido`
  ...
  ADD CONSTRAINT `FKsr7cp0iywhr8amwh3mkledigp` FOREIGN KEY (`prduto_id`) REFERENCES `produto` (`id`);
